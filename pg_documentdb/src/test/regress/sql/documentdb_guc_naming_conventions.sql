...
INSERT INTO documentdb_guc_naming_baseline (name) VALUES
    ...
    ('documentdb.enableDollarInToScalarArrayOpExprConversion'),
    ...
    ('documentdb.enableDropInvalidIndexesOnReadOnly'),
    ...
    ('documentdb.enableIndexOnlyScan'),
    ...
    ('documentdb.enableIndexOnlyScanOnCost'),
    ...
    ('documentdb.usePgStatsLiveTuplesForCount'),
