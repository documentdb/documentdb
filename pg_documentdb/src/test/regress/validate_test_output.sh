...
validationExceptions="/sql/documentdb_test_helpers.sql /sql/public_api_schema.sql /sql/documentdb_guc_naming_conventions.sql /sql/documentdb_rum_guc_naming_conventions.sql /sql/documentdb_server_version_guc.sql"
