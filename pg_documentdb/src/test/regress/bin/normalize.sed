...
# Parallel RUM index builds can report a platform-dependent indextuple count in
# DEBUG output; normalize the tuple counts so regression comparisons remain stable.
s/parallel index build completed with [0-9.]+ heaptuples and [0-9.]+ indextuples/parallel index build completed with XXX heaptuples and YYY indextuples/g
