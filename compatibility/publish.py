...
def render(
    ...
    *,
    ...
    page = environment.get_template("index.html").render(rows=rows, generated_at=generated)
...
def main() -> int:
    ...
    if args.site:
        render(args.store, args.site, registry, issue_repository=args.issue_repository)
